...
function LandingView({ onStart }) {
  return (
    <div style={{ textAlign: "center", padding: "40px 20px" }}>
      ...
      <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "16px", color: theme.textMuted, lineHeight: 1.7, maxWidth: "520px", margin: "0 auto 40px" }}>Answer questions curated by real industry experience about your warehouse operations across five critical areas. Get a detailed, AI-powered audit report, designed to match your answers against the best industry research and standards. Access tailored recomendations that could cut costs, speed up dispatch, and fix what's slowing you down.</p>
